...
// 请求体
{
  "code": "test", 		 	// wx.getPhoneNumber 获取
  "loginCode": "test", 	// wx.login 获取
...
// Header
authration_token: cj5q9eon29fs73dl2u80 // 登陆接口返回的 TOKEN
...
// 响应体：
{
    ...
    "message": "",
    "data": {
        "url": "https://img.xxx.com/298_1736493615123456789.png"
    }
}
```
