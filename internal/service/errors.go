...
var (
	...
	ErrVirtualPaymentUnavailable    = errors.New("virtual payment is not configured for this order")
	ErrVirtualPaymentOrderInvalid   = errors.New("virtual payment requires a pending single-item order")
	ErrVirtualPaymentOrderClosed    = errors.New("virtual payment order has been closed")
	ErrVirtualPaymentLoginInvalid   = errors.New("invalid virtual payment login code")
	ErrVirtualPaymentNotifyMismatch = errors.New("virtual payment notification does not match order")
